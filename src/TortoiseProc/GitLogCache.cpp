...
int CLogCache::LoadOneItem(GitRevLoglist& Rev,ULONGLONG offset)
{
	...
	SLogCacheRevItemHeader* header = reinterpret_cast<SLogCacheRevItemHeader*>(this->m_pCacheData + offset);
	...
	fileheader = reinterpret_cast<SLogCacheRevFileHeader*>(this->m_pCacheData + offset);
